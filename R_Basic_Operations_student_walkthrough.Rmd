...
```{r}
substr("how much wood would a wood chuck chuck?", start <- 5, stop <- 13)
```
...
```{r}
sub("wood", "would", "How much wood would a wood chuck chuck?")
# help(sub)
```
...
1.  Create two strings with your first and last name, respectively. Then concatenate them, and print the new value as "My name is \<your newly created concatenated variable will go here\>"
    ...
    first_name <- "Carl"
    last_name <- "Miller"
    hello_world <- paste(first_name, last_name)

    sprintf("My name is %s.", hello_world)
    ```
